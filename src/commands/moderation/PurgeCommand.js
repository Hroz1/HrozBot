...
module.exports = class PurgeCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ...
    if (!amountToDelete || amountToDelete < 2 || amountToDelete > 100) return message.channel.send('The number stated must be betweem 2 and 100');
    ...
    try {
      ...
      console.log(err);
      message.channel.send('I was unable to delte the amount stated, make sure they are withing 14 days old.');
    }
  }
}